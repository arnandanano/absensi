...
<head>
  ...
  <title>Data Karyawan | Skynet Media Utama</title>
				  ...
				  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
					  ...
					  <div class="form-group">
						...
						<select class="form-control" name="division">
							<option value="Customer Service" <?php if($division=="Customer Service") echo 'selected="selected"'; ?> >Customer Service</option>
							<option value="Petugas Instalasi" <?php if($division=="Petugas Instalasi") echo 'selected="selected"'; ?> >Petugas Instalasi</option>
						</select>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Skynet Media Utama 2022</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
